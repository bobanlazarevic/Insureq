package com.insureq.blazarevic.demo.controller;
...
public class PersonController {
    ...
    public ResponseEntity<Person> updatePerson(@PathVariable Long personID, @RequestBody Person p) {
        Person person = personService.updatePerson(personID, p);
        return Objects.nonNull(person) ? new ResponseEntity<>(HttpStatus.ACCEPTED) : new ResponseEntity<>(HttpStatus.NOT_MODIFIED);
    }
}
